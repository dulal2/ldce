...
const quizData = {
  ...
  {
    "question": "Division time table meeting held in month of.
      मण्डल समय सारणी की बैठक किस माह में होती है?",
  ...
  {
    "question": "Block Back and Block Forward are related to..
     ब्लॉक बैक और ब्लॉक फॉरवर्ड किससे संबंधित हैं?",
