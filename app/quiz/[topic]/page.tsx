...
const quizData = {
  ...
  Train_Manager: [
    {
     question: "Authority to start a train from non-signalled line of a station is.
     किसी स्टेशन की गैर-सिग्नल लाइन से ट्रेन खुलाने के लिए प्राधिकार है...",
     options: ["T/369(3b)", "T/511", "T/512", "T/509"],
     correctAnswer: 1,
    },
    {
     question: "Authority to start a train from a line with common starter signal is.
     सामान्य स्टार्टर सिग्नल वाली लाइन से ट्रेन खुलाने के लिए प्राधिकार है...",
    ...
    {
     question: "Authority to proceed without line clear is.
     लाइन क्लियर के बिना आगे बढ़ने का प्राधिकार है...",
     options: ["T/B602", "T/C602", "T/A602", "T/D602"],
     correctAnswer:2,
    },
    {
     question: "Paper line clear ticket for up direction is.अप दिशा के लिए पेपर लाइन क्लियर टिकट है...",
     options: ["T/D 1425", "T/B 1425", "T/C 1425", "T/A 1425"],
     correctAnswer: 2,
    },
    {
     question: "Conditional line clear ticket is..सशर्त लाइन क्लियर टिकट है...",
     options: ["T/G 602", "T/F 602", "T/E 602", "T/I 602"],
     correctAnswer:2,
    },
    {
     question: "Authority for temporary single line working on double line in absolute block section is
                पूर्ण ब्लॉक सेक्शन में डबल लाइन पर काम करने वाली अस्थायी सिंगल लाइन के लिए प्राधिकरण है...",
     options: ["T/A 602", "T/B 602", "T/C 602", "T/D 602"],
     correctAnswer:3,
    },
    {
     question: "Maximum speed while shunting on T/806 is..
     टी/806 पर शंटिंग करते समय अधिकतम गति _ किमी प्रति घंटा है...",
     options: ["5 km/h", "10 km/h", "15 km/h", "20 km/h"],
     correctAnswer:2,
    },
    {
     question: "Authority given during TFC on double line is..
     डबल लाइन पर टीएफसी के दौरान दिया गया प्राधिकार है...",
     options: ["T/A 602", "T/B 602", "T/C 602", "T/D 602"],
     correctAnswer:2,
    },
    {
     question: "Train intact arrival register is..ट्रेन पूर्ण आगमन रजिस्टर है...",
     options: ["T/1410", "T/1525", "T/A1425", "TB 1425"],
     correctAnswer:0,
    },
    {
     question: "Authority for temporary single line working on double line in automatic block section is..
                स्वचालित ब्लॉक अनुभाग में डबल लाइन पर काम करने वाली अस्थायी सिंगल लाइन के लिए प्राधिकरण है...",
     options: ["T/B 912", "T/C 912", "T/D 912", "T/E 912"],
     correctAnswer:3,
    },
    {
     question: "Authority to proceed for relief engine into an automatic block signalling section is.
                स्वचालित ब्लॉक सिग्नलिंग अनुभाग में रिलीफ इंजन के लिए आगे बढ़ने का प्राधिकार है...",
     options: ["T/A 912", "T/B 912", "T/C 912", "T/D 912"],
     correctAnswer:0,
    },
    {
     question: "Motor trolley permit is...मोटर ट्रॉली परमिट है...",
    ...
    {
     question: "How much depth of ballast is available in BG group A route below the bottom of the sleeper?
               BG में A मार्ग में स्लीपर के निचे बल्लास्ट की गहराई कितना होता है?",
    ...
    {
     question: "The normal height of contact wire is regulated OHE section is
                 रेगुलेटे OHE सेक्शन में कॉन्टेक्ट तार की ऊंचाई क्या होती है?",
     options: ["5.75m", "5.60m", "5.65m", "4.65m"],
     correctAnswer:1,
    },
    {
     question: "Which loco is used for both service (passenger and freight)?
     किस लोको का उपयोग दोनों सर्विस (passenger and freight) में होता है?",
     options: ["WAG5", "WAG7", "WAM4", "WAP4"],
      correctAnswer:3,
    },
    {
     question: "What type of pantograph is used in Indian railway for 25KV AC electric loco?
     भारतीय रेलवे में 25 KV AC के लिए किस प्रकार के पेंटोग्राफ का उपयोग होता है?",
     options: ["AM12", "AM10", "AM14", "All the above"],
     correctAnswer:0,
    },
    {
     question: "Under Running staff review, 1 (one) shunter is demanded for rest giver for.
     रनिंग स्टाफ रिव्यु के अंतर्गत एक शांटर की व्यवस्था कितने शांटर के लिए की जाती है?",
     options: ["6", "8", "4", "10"],
     correctAnswer:0,
    },
    {
     question: "Wagon km is example of.वैगन किलोमीटर किस इकाई का उदाहरण है?",
     options: ["Primary unit", "Fundamental unit", "Derived unit", "None of the above"],
     correctAnswer:1,
    },
    {
     question: "Division time table meeting held in month of.मण्डल समय सारणी की बैठक किस माह में होती है?",
      
     options: ["October", "September", "December", "June"],
     correctAnswer:1,
    },
    {
      question: "Principle of making time table is.समय सारणी बनाने का सिद्धांत क्या है?",
      options: ["Passenger convenience", "Operational need", "Running time of train", "All the above"],
      correctAnswer:3,
    },
    {
      question: "SPAD of passenger train comes under which class of accident?
     यात्री गाड़ी की SPAD किस क्लास का दुर्घटना है?",
      options: ["D", "B", "H1", "H2"],
      correctAnswer:2,
    }, 
    {
     question: "What is the duration of IOH Maintenance for conventional loco for coaching train
     कोचिंग लोको जो कान्वेंशनल टाइप का होता हैं उसका IOH का समय क्या होता हैं",
     options: ["4 Hours", "6 Hours", "6 days", "9 days"],
     correctAnswer:3,
     },
     {
      question: "Escaping of wagon in right line on D/L section what beats given to advance station?
                डबल लाइन के सेक्शन में सही लाइन से गाड़ी भागने पर क्या बीट दिया जाता हैं?",
     ...
     },
     {
      ...
      {
        question: "Roll on - Roll off plan is introduced for the first time where?
        रोल ऑन रोल ऑफ योजना कहाँ प्रारंभ किया गया था?",
        options: ["ECR", "ER", "KOKAN RAILWAY", "NR"],
        correctAnswer: 2,
      },
      {
       question: "Standard rake of BOXNHL is.BOXNHL का मानक रेक कितने वैगन का होता है?",
       options: ["59", "58", "42", "35"],
       correctAnswer: 1,
      },
      {
       question: "What is the full form of POH?POH का फुलफॉर्म क्या होता है?",
       options: ["Partial overhauling", "Periodical over hauling", "Particular overhauling", "Part overhauling"],
       correctAnswer:1,
      },
      {
       question: "Block Back and Block Forward are related to..ब्लॉक बैक और ब्लॉक फॉरवर्ड किससे संबंधित हैं?",
